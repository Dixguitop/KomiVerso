...
// Suscripciones ("Plan Fan"): el sistema sigue completo en el código, pero con
// false no hay ningún botón ni acceso visible. Cámbialo a true para reactivarlo.
...
// 👉 Social Bar es una unidad DISTINTA a la del banner de arriba. En Adsterra:
...
// Las tres redes/formatos se piden al mismo tiempo, cada uno de forma
// independiente. Ninguno espera a otro ni depende de que otro falle: si
// ExoClick no devuelve anuncio, Adsterra (banner) igual se muestra, y el
// Social Bar se dispara aparte sin importar los otros dos.
// El Social Bar NO se pone de fondo en toda la web — solo vive dentro de
// este iframe del gate de anuncio (15s), para no interferir con la lectura
// normal fuera de esta pantalla.
...
(function(){
  var bar=document.createElement("script"); bar.type="text/javascript";
  bar.src="${ADSTERRA_SOCIALBAR_SRC}";
...
const PLANS = [
  ...
  { id: "fan", nombre: "Fan", precio: "$3.50", periodo: "USD / mes", detalle: "Te quitamos los anuncios y nos estarias apoyando un montón ♥." },
];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6" style={{ background: "var(--bg)", color: "var(--text)" }}>
      <div className="max-w-sm text-center">
        ...
        <p className="text-sm mb-6" style={{ color: "var(--muted)" }}>
          Los anuncios nos ayudan a mantener KōmiVerso gratis. Desactiva tu adblock para este sitio (o añádelo a la lista de excepciones) y vuelve a intentarlo.{SUBSCRIPTIONS_ENABLED ? " También puedes suscribirte para leer sin anuncios." : ""}
        </p>
...
// Sin el botón de suscripción solo queda el del corazón (contenedor más bajo).
const FAB_W = 52, FAB_H = SUBSCRIPTIONS_ENABLED ? 122 : 56;
...
function AppInner() {
  ...
  return (
    <div className="max-w-lg mx-auto min-h-screen relative" style={{ paddingBottom: isReader ? 0 : 64 }}>
      ...
      {SUBSCRIPTIONS_ENABLED && <SubscriptionModal open={subOpen} onClose={() => setSubOpen(false)} auth={auth} setAuthModal={setAuthModal} />}
